...
class AddUserCommandTest extends KernelTestCase
{
     ...
     * arguments.
     * See https://symfony.com/doc/current/components/console/helpers/questionhelper.html#testing-a-command-that-expects-input //phpcs:ignore
     */
     ...
     * @param array $inputs    The (optional) answers given to the command when it asks for the value of the missing arguments // phpcs:ignore
     */
